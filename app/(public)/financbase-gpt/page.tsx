...
import { Bot, Sparkles, Brain, TrendingUp, Shield, Zap, ArrowUpRight } from "lucide-react";

const EXTERNAL_GPT_URL = "https://chatgpt.com/g/g-68e6295a7fb48191b4ac212ef64ee647-financbasegpt";
			...
			<div className="rounded-lg border border-purple-200 bg-gradient-to-r from-purple-50 to-blue-50 p-8">
				<div className="max-w-2xl mx-auto text-center">
					...
					<p className="text-muted-foreground mb-6">
						Experience the future of AI-powered financial intelligence. Start your conversation 
						with FinancbaseGPT now and get expert financial guidance powered by GPT-4.
					</p>
