...
const DeviceIcon = ({
	type,
	className,
}: { type: "phone" | "laptop"; className?: string }) => {
			...
			<CardContent className="px-6 pb-6">
				...
				<div className="flex items-center justify-between gap-2 text-center text-sm mb-8">
					...
					<div className="flex items-center gap-1 text-primary pt-2">
						...
						<span className="h-1 w-1 bg-primary rounded-full animate-pulse [animation-delay:-0.3s]" />
						<span className="h-1 w-1 bg-primary rounded-full animate-pulse [animation-delay:-0.15s]" />
