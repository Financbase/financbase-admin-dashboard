...
const navigation = [
  ...
  { name: "Job Management", href: "/jobs", icon: Briefcase, current: false },
  { name: "Gig Management", href: "/gigs", icon: Package, current: false },
  { name: "Payments & Wallet", href: "/payments", icon: CreditCard, current: false },
  { name: "Reports & Reviews", href: "/reports", icon: Flag, current: false },
  { name: "Notifications", href: "/notifications", icon: Bell, current: false },
  { name: "Blog / CMS", href: "/blog", icon: FileText, current: false },
