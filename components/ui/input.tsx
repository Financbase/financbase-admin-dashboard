  ...
  ({ className, type, inputMode, autoInputMode = true, ...props }, ref) => {
    ...
    return (
      <input
        ...
        className={cn(
          "flex h-10 w-full rounded-md border border-input bg-background px-4 py-2.5 text-sm leading-normal ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:border-ring disabled:cursor-not-allowed disabled:opacity-50 transition-colors",
          className
        )}
        ref={ref}
        {...props}
