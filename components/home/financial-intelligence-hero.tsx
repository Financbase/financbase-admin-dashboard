  ...
  const features = [
    {
      ...
      description: "Get intelligent financial insights powered by machine learning"
    },
    {
    ...
    },
    {
      ...
      description: "Actionable recommendations to optimize your finances"
    }
  ]
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1]">
                <span className="text-slate-900">Financial Intelligence</span>
                <br />
              ...
              <p className="text-xl md:text-2xl text-slate-600 leading-relaxed max-w-2xl">
                AI-powered insights, predictions, and strategic recommendations to transform how you manage your business finances. Make smarter decisions with confidence.
              </p>
            </div>
            ...
            <Card className="relative overflow-hidden bg-white/95 backdrop-blur-sm border-0 shadow-2xl">
              <CardContent className="p-0">
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-200">
                  ...
                  <div className="text-sm text-slate-500">Financial Intelligence Dashboard</div>
                </div>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    {[
                      { id: "insight-001", title: "Cash flow improving", impact: "High", status: "positive" },
                      { id: "insight-002", title: "Revenue growth opportunity", impact: "Medium", status: "opportunity" },
                      { id: "insight-003", title: "Expense optimization", impact: "High", status: "recommendation" }
                    ].map((insight) => (
                      <div key={insight.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                        <div>
                          ...
                          <div className="text-xs text-slate-500">{insight.impact} impact</div>
                        </div>
                        <div className="text-sm font-semibold text-slate-900">{insight.status}</div>
                      </div>
                    ))}
                  </div>
                </div>
